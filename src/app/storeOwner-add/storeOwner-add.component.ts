...
export class StoreOwnerAddComponent implements OnInit {
  ...
  addStoreOwner() {
    ...
    this.storeOwnerService.addStoreOwner(uploadData).subscribe((response:any) => { this.response = response; this.alertify.success(response.msg);},
      error => this.alertify.error(this.response.msg),
      () => {  });
  }
