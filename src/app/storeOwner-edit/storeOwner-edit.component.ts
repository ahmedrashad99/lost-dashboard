...
export class StoreOwnerEditComponent implements OnInit {
  ...
  constructor(private storeOwnerService: StoreOwnerService, private router: Router, private fb: FormBuilder, private alertify: AlertifyService, private route: ActivatedRoute) { }

  ngOnInit() {
    this.governmentInit();
    this.storeOwnerService.getStoreOwner(this.storeOwnerIdOfEdit).subscribe((data: any) => {
      this.storeOwner = data.Data;
      console.log(this.storeOwner);
    }, error => {
